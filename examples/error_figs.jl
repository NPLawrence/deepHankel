...
default(fontfamily=plot_font,
        linewidth=2, framestyle=:axes, grid=true)
# scalefontsizes(1.3)
...
function depth_predict(B::behavior; L_list = [2 5 10 20], rollouts=10, solver=nothing, method="Noisy")
...
"""
function depth_mse(P, σ²; methods=["Noisy" "Smooth" "SSA"], L_list = 2:20, N_list = [150 200 250], rollouts=10, save_path="./examples/data/mse.bson")
...
function mse_plot(mse; save_path="./figures/mse_plot_median_delete")
    gr()
    colors = palette(:default)
